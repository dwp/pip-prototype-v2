  ...
  "contactPref" : [
    {
      ...
      "textareaHintText" : "Eg larger than 16pt print. We can only provide this if it’s necessary because of your condition.",
      "backLink"         : "/pip20/contactDetails"
    },
  ],
  "currentWhereabouts" : [
    {
  ...
  "nationality" : [
    {
      ...
      "backLink"         : "/pip20/currentWhereabouts"
    },
  ],
  "paymentsFromAbroad" : [
    {
  ...
  "medications" : [
    {
      ...
      "removeLink"       : "Remove this",
      "backLink"         : "/pip20/conditionDetails"
    },
  ],
  "manageMedications" : [
    {
  ...
  "treatments" : [
    {
      ...
      "backLink"         : "/pip20/manageMedications",
  ...
  "healthcareprofessional" : [
    {
      ...
      "removeLink"       : "Remove this",
      "backLink"         : "/pip20/monitoringCondition"
    },
  ],
  "hcpConsent" : [
    {
  ...
  "submitEvidence" : [
    {
      ...
      "backLink"         : "/pip20/healthcareprofessional"
    },
  ],
  "specialAids" : [
    {
  ...
  "gettingUp" : [
    {
      ...
      "backLink"         : "/pip20/summaryMain?show=yourHome&next=gettingUp&back=hearing"
    },
  ],
  "toilet" : [
   {
  ...
  "eatingAndDrinking" : [
   {
     ...
     "backLink"         : "/pip20/summaryMain?show=gettingOut&next=gettingOut&back=eatingAndDrinking"
    },
  ],
  "gettingOut" : [
    {
  ...
  "mixing" : [
    {
      ...
      "backLink"         : "/pip20/eatingAndDrinking"
    },
  ],
  "localJourney" : [
    {
      ...
      "backLink"         : "/pip20/summaryMain?show=understanding&next=localJourney&back=mixing"
    },
  ],
  ...
  "somewhereYouKnow" : [
    {
      ...
      "backLink"         : "/pip20/somewhereNeverBeenBefore"
    },
  ],
  "understanding" : [
    {
      ...
      "backLink"         : "/pip20/somewhereYouKnow"
    },
  ],
  "money" : [
    {
  ...
  "additionalInfo" : [
    {
      ...
      "submit"           : "Save and continue",
      "backLink"         : "/pip20/checkYourAnswers"
    },
  ],
  "declaration" : [
    {
      ...
      "backLink"         : "/pip20/paymentsFromAbroad"
    },
  ],
  "declaration2" : [
    {
