  ...
  "specialAids" : [
    {
      ...
      "doesntLabel"       : "You do <span class='bold-small'>not</span> rely on aids, adaptations or anything else to make things easier for you",
  ...
  "sight" : [
    {
      ...
      "helpTextHd"       : "Include if your level of sight changes depending on:",
  ...
  "localJourney" : [
    {
      ...
      "introText"        : "This question is about how you would plan to get to somewhere local that you’ve never been before. It’s not about getting there - you’ll have chance to tell us about that in another question. If you would not plan a journey yourself, explain whether you could if you had to.",
  ...
  "somewhereNeverBeenBefore" : [
    {
      ...
      "relySomeoneLabel" : "Someone would need to be with you",
      ...
      "helpTextHd"       : "Include if:",
      "helpText"         : ["what you can do depends if you have been to the place before","what you can do depends on the type of day you’re having","you risk having an accident or hurting yourself","if your condition would affect how long it takes you to get somewhere","getting somewhere you have never been would have an effect on your condition"],
