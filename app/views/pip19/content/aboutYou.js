  ...
  "nationality" : [
    {
      ...
      "backLink"         : "/pip19/currentWhereabouts"
    },
  ],
  "paymentsFromAbroad" : [
    {
  ...
  "conditionDetails" : [
    {
      ...
      "backLink"         : "/pip19/summaryMain?show=yourCondition&next=conditionDetails&back=paymentsFromAbroad"
    },
  ],
  "medications" : [
    {
      ...
      "removeLink"       : "Remove this",
      "backLink"         : "/pip19/conditionDetails"
    },
  ],
  "manageMedications" : [
    {
  ...
  "treatments" : [
    {
      ...
      "backLink"         : "/pip19/manageMedications",
  ...
  "healthcareprofessional" : [
    {
      ...
      "removeLink"       : "Remove this",
      "backLink"         : "/pip19/monitoringCondition"
    },
  ],
  "hcpConsent" : [
    {
  ...
  "submitEvidence" : [
    {
      ...
      "backLink"         : "/pip19/healthcareprofessional"
    },
  ],
  "specialAids" : [
    {
  ...
  "gettingUp" : [
    {
      ...
      "backLink"         : "/pip19/summaryMain?show=yourHome&next=gettingUp&back=hearing"
    },
  ],
  "toilet" : [
   {
  ...
  "eatingAndDrinking" : [
   {
     ...
     "backLink"         : "/pip19/summaryMain?show=gettingOut&next=gettingOut&back=eatingAndDrinking"
    },
  ],
  "gettingOut" : [
    {
  ...
  "mixing" : [
    {
      ...
      "backLink"         : "/pip19/eatingAndDrinking"
    },
  ],
  "localJourney" : [
    {
      ...
      "backLink"         : "/pip19/summaryMain?show=understanding&next=localJourney&back=mixing"
    },
  ],
  ...
  "somewhereYouKnow" : [
    {
      ...
      "backLink"         : "/pip19/somewhereNeverBeenBefore"
    },
  ],
  "understanding" : [
    {
      ...
      "backLink"         : "/pip19/somewhereYouKnow"
    },
  ],
  "money" : [
    {
