  ...
  "registered"         : [
    {
      ...
      "question3"        : "If you have not got the email within one hour <a href='/pip23/login'>enter your email address again.</a>"
    },
  ],
  ...
  "medications" : [
    {
      ...
      "removeLink"       : "Remove this",
      "backLink"         : "/pip23/conditionDetails"
    },
  ],
  "manageMedications" : [
    {
  ...
  "treatments" : [
    {
      ...
      "backLink"         : "/pip23/manageMedications",
  ...
  "submitEvidence" : [
    {
      ...
      "backLink"         : "/pip23/monitoringCondition"
    },
  ],
  "specialAids" : [
    {
  ...
  "gettingOut" : [
    {
      ...
      "backLink"         : "/pip23/eatingAndDrinking"
    },
  ],
  "mixing" : [
    {
  ...
  "somewhereYouKnow" : [
    {
      ...
      "backLink"         : "/pip23/somewhereNeverBeenBefore"
    },
  ],
  "understanding" : [
    {
  ...
  "declaration" : [
    {
      ...
      "backLink"         : "/pip23/healthcareprofessional"
    },
  ],
  "completionDate" : [
    {
